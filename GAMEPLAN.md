...
- [ ] **F2 · Modelo de dados** — Tipos, Raridade, Criatura, Esquadrão, Sinergias e a tabela de fórmulas configurável. *Teste: nada visual; validar com um preview dos stats no console.*
